...
# Form implementation generated from reading ui file 'customWhole.ui'
#
...
class Ui_menuShell(object):
    def setupUi(self, menuShell):
        ...
        self.scrollArea = QtWidgets.QScrollArea(menuShell)
        self.scrollArea.setGeometry(QtCore.QRect(150, 20, 721, 551))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 719, 549))
    ...
    def retranslateUi(self, menuShell):
        ...
        self.label_3.setText(_translate("menuShell", "Ingredient 2"))
        self.label_2.setText(_translate("menuShell", "Ingredient 1"))
        self.label_4.setText(_translate("menuShell", "Ingredient 3"))
        self.label.setText(_translate("menuShell", "Temp Curstom Drank"))
        self.label_5.setText(_translate("menuShell", "Ingredient 2"))
        self.label_7.setText(_translate("menuShell", "Ingredient 1"))
        self.label_8.setText(_translate("menuShell", "Ingredient 3"))
        self.label_6.setText(_translate("menuShell", "Not proper layout "))
