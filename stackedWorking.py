...
class Ui_B3GUI(QtWidgets.QMainWindow):
    ...
    def setupPrimary(self):
        ...
        self.widget_2.setGeometry(QtCore.QRect(150, 20, 721, 561))
        self.widget_2.setAutoFillBackground(False)
        self.widget_2.setObjectName("widget_2")
        self.scrollArea_menu = QtWidgets.QScrollArea(self.widget_2)
        self.scrollArea_menu.setGeometry(QtCore.QRect(0, 0, 721, 561))
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(10, 10, 671, 471))
        ...
        self.gridLayout_menuRecipe = QtWidgets.QGridLayout()
        self.gridLayout_menuRecipe.setObjectName("gridLayout_menuRecipe")
        ...
        self.gridLayout_menuRecipe.addWidget(self.label_recipeIngDynamicLater, 3, 0, 1, 1)
        self.label_recipeIng1 = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.label_recipeIng1.setObjectName("label_recipeIng1")
        self.gridLayout_menuRecipe.addWidget(self.label_recipeIng1, 2, 0, 1, 1)
        self.label_37 = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.label_37.setObjectName("label_37")
        self.gridLayout_menuRecipe.addWidget(self.label_37, 4, 0, 1, 1)
        ...
        self.gridLayout_menuRecipe.addWidget(self.line_menuRecipe, 1, 0, 1, 1)
        ...
        self.label_recipeIngDynamicLater2.setMinimumSize(QtCore.QSize(0, 50))
        self.label_recipeIngDynamicLater2.setObjectName("label_recipeIngDynamicLater2")
        self.gridLayout_menuRecipe.addWidget(self.label_recipeIngDynamicLater2, 0, 0, 1, 1)
        self.gridLayout_menu.addLayout(self.gridLayout_menuRecipe, 0, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.line_6, 1, 0, 1, 1)
        ...
        self.gridLayout_menu.addLayout(self.gridLayout_6, 0, 2, 1, 1)
...
"Tools"))
        ...
        self.label_37.setText(_translate("B3GUI", "Ingredient 3"))
        self.label_recipeIngDynamicLater2.setText(_translate("B3GUI", "NameofDrink"))
        self.label_39.setText(_translate("B3GUI", "Ingredient 2"))
        self.label_40.setText(_translate("B3GUI", "Ingredient 1"))
        self.label_41.setText(_translate("B3GUI", "Ingredient 3"))
        self.label_42.setText(_translate("B3GUI", "NameofDrink"))
