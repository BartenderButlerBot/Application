...
class Ui_B3GUI(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.paletteWidgetRed = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(175, 50, 25))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.paletteWidgetRed.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        brush = QtGui.QBrush(QtGui.QColor(175, 50, 25))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.paletteWidgetRed.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        brush = QtGui.QBrush(QtGui.QColor(175, 50, 25))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.paletteWidgetRed.setBrush(QtGui.QPalette.Inactive, QtGui.QPalette.Button, brush)
        brush = QtGui.QBrush(QtGui.QColor(175, 50, 25))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.paletteWidgetRed.setBrush(QtGui.QPalette.Inactive, QtGui.QPalette.Base, brush)
        brush = QtGui.QBrush(QtGui.QColor(175, 50, 25))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.paletteWidgetRed.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Button, brush)
        brush = QtGui.QBrush(QtGui.QColor(175, 50, 25))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.paletteWidgetRed.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Base, brush)
